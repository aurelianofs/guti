...
var store = (0, _redux.createStore)(_reducers2.default); //var socket = new WebSocket('ws://localhost:8080');
...
*/
var aa=__webpack_require__(1),l=__webpack_require__(11),B=__webpack_require__(5),C=__webpack_require__(2),ba=__webpack_require__(12),da=__webpack_require__(13),ea=__webpack_require__(14),fa=__webpack_require__(15),ia=__webpack_require__(16),D=__webpack_require__(6);
...
var _chatbox = __webpack_require__(33);

var _chatbox2 = _interopRequireDefault(_chatbox);

var _chatInput = __webpack_require__(36);
...
var ChatMsg = function ChatMsg(_ref) {
  var msg = _ref.msg;
  return _react2.default.createElement(
    'p',
...
var ChatBox = function ChatBox(_ref2) {
  ...
  var messagesNode = messages.map(function (msg) {
    return _react2.default.createElement(ChatMsg, { key: msg.id, msg: msg.text });
  });
...
ChatBox = (0, _reactRedux.connect)(mapStateToProps)(ChatBox);
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/sass-loader/lib/loader.js!./chatbox.scss", function() {
			var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/sass-loader/lib/loader.js!./chatbox.scss");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
var ChatInput = function ChatInput(_ref) {
  ...
  return _react2.default.createElement(
    'div',
    null,
    _react2.default.createElement('input', { className: 'chat-input', ref: function ref(node) {
        input = node;
      }, placeholder: 'Type a message...', onKeyPress: function onKeyPress(event) {
        if (event.key == 'Enter') {
          var message = input.value;

          if (!message) return;

          dispatch((0, _actions.addMessage)(message, 'aure'));
          input.value = '';
        }
      }, type: 'text' })
  );
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_es_isPlainObject__ = __webpack_require__(42);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__warning__ = __webpack_require__(41);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__utils_warning__ = __webpack_require__(41);
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(49), __webpack_require__(73)(module)))
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utils_warning__ = __webpack_require__(41);
...
var _chat = __webpack_require__(86);
...
var messageId = 0;
var addMessage = exports.addMessage = function addMessage(text, author) {
  return {
    type: 'ADD_MESSAGE',
    id: messageId++,
    text: text,
